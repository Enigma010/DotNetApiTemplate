...
namespace App.Core.Repositories
{
        ...
        where IdType : IComparable
    {
        ...
        {
            _logger.LogInformationCaller("GetAsync expression: {@expression}, paging: {@paging}", args: [expression, paging]);
        ...
        {
            _logger.LogInformationCaller("GetAsync paging: {@paging}", args: [paging]);
